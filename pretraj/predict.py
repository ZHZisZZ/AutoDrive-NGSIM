...
#     predict_frames: int,
# ) -> Tuple[List[int], List[int], List[int], bool]:
#   """Simulate the trajectory of ego vehicle based on neural network model.
...
if __name__ == '__main__':
  ...
  ego = Vehicle(**pair_info[2]['ego'])
  pre = Vehicle(**pair_info[2]['pre'])
